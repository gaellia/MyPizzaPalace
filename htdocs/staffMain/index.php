		...
		<tr>
			<td colspan="2">
				<table width="105" cellpadding="0" cellspacing="0" cols="2">
					<tr height="100">
						<td bgcolor="#8D8D8D">
							<a href="staffOrders.php" target="main">
								<p class="sidebar">
									Orders
								</p>
							</a>
					...
					<tr height="100">
						<td bgcolor="#8D8D8D">
							<a href="staffProfile.php" target="main">
								<p class="sidebar">
									Profile
								</p>
							</a>
					...
					<tr height="100">
						<td bgcolor="#8D8D8D">
							<a href="staffSchedule.php" target="main">
								<p class="sidebar">
									Schedule
								</p>
							</a>
			...
			<td align="center" colspan="6" height="790" background="">
				<iframe name="main" src="staffOrders.php" width="100%" height="100%" frameborder="0" />
			</td>
